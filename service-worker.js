const CACHE = 'dango-shell-v5.2.3';
const SHELL = [
  './', './index.html', './style.css', './app-loader.js', './app.js', './hotfix.js', './manifest.json',
  './icon/icon-192.png', './icon/icon-512.png', './icon/apple-touch-icon.png'
];
const CORE_PATHS = new Set(['/index.html','/style.css','/app-loader.js','/app.js','/hotfix.js','/manifest.json']);
